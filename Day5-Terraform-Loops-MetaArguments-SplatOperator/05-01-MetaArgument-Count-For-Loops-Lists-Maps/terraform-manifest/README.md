...
## Step-02: i1-versions.tf 
- No changes

## Step-03: i2-variables.tf - Lists and Maps
```t
...
## Step-04: i3-ec2securitygroups.tf and c4-ami-datasource.tf
- No changes to both files

## Step-05: i5-ec2instance.tf
```t
