...
resource "aws_autoscaling_schedule" "increase_capacity_7am" {
  ...
  max_size               = 10
  desired_capacity       = 4
  start_time             = "2026-06-16T11:20:00Z" # Time should be provided in UTC Timezone (11am UTC = 7AM EST)
  recurrence             = "00 09 * * *"
...
resource "aws_autoscaling_schedule" "decrease_capacity_7pm" {
  ...
  max_size               = 10
  desired_capacity       = 2
  start_time             = "2026-06-16T11:40:00Z" # Time should be provided in UTC Timezone (11am UTC = 7AM EST)
  recurrence             = "00 19 * * *"
