...
- Choose a domain name: abcabc and click on **Check** 
...
1. Fixed Response for /* : http://apps.vinodnayan.academy   
2. App1 /app1* goes to App1 EC2 Instances: http://apps.vinodnayan.academy/app1/index.html
3. App2 /app2* goes to App2 EC2 Instances: http://apps.vinodnayan.academy/app2/index.html
...
- Files from `i1 to i10`
- Create new files
  - i6-02-datasource-route53-zone.tf
  - i11-acm-certificatemanager.tf
  - i12-route53-dnsregistration.tf
- Review the files
  - app1-install.sh
  - app2-install.sh  

## Step-03: i5-05-securitygroup-loadbalancersg.tf
- Update load balancer security group to allow port 443
```t
  ingress_rules = ["http-80-tcp", "https-443-tcp"]
```

## Step-04: i6-02-datasource-route53-zone.tf
...
## Step-05: i7-04-ec2instance-private-app1.tf
...
## Step-06: i7-05-ec2instance-private-app2.tf
...
1. Fixed Response: http://apps.vinodnayan.academy   
2. App1 Landing Page: http://apps.vinodnayan.academy/app1/index.html
3. App1 Metadata Page: http://apps.vinodnayan.academy/app1/metadata.html
4. App2 Landing Page: http://apps.vinodnayan.academy/app2/index.html
5. App2 Metadata Page: http://apps.vinodnayan.academy/app2/metadata.html
```
